...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        FROM tabela_cliente WHERE dtnasc = ?');
        $stmt->execute([$dtnasc]);
        ...
        if ($count > 0) {
            ...
            $stmt = $pdo->prepare('INSERT INTO tabela_cliente (nome, email, telefone, dtnasc) VALUES (:nome, :email, :telefone, :dtnasc)');
